...
-- add title bar
--
function set_title(c)
  c.titlebar = titlebar({position="tot"})
  title = widget({type="textbox", name "my title"})
  c.titlebar:widgets({title})
end
awful.hooks.manage.register(set_title)
